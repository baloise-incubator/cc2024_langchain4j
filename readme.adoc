...
* TDD such an app
* ollama stuff
** try create embeddings from a code base, eg https://www.youtube.com/watch?v=aD-u0gl93wM

=== Done
* ollama stuff
** try vscode integration (replacement for github copilot): https://github.com/bernardo-bruning/ollama-copilot?tab=readme-ov-file
